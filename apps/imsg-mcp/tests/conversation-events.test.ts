 ...
 * item_type 1 = member change (`group_action_type` 0 add / 1 remove,
 * member in `other_handle`), 2 = rename (`group_title`), 3 = actor left.
 */
...
const GROUP_ID = "chat555666777888999000";
const T0 = (1735689600 - 978307200) * 1e9; // 2025-01-01 in Mac-epoch ns
